        ...
        <Nb>
            <Nbwrap click={click}>
                ...
                <div className='lst' click={click}>
                    <div className="lst2">
                        <a href="#home" className="mdnav" onClick={handleLinkClick}>Home</a>
                        ...
                        <a href="#help" className="mdnav" onClick={handleLinkClick}>Help</a>
                    </div>
                    <a href="#contact" className="but" onClick={handleLinkClick}>Contact Us</a>
                </div>
            </Nbwrap>
        </Nb>
    )
...
const Nbwrap = styled.div`
    ...
    .lst {
        ...
        @media screen and (max-width: 600px){
            ...
            width: 90%;
            right: 0;
            animation: ${({ click }) => (click ? 'slideIn 2s forwards' : 'slideOut 2s forwards')};
            z-index: 1;
            align-items: center;
